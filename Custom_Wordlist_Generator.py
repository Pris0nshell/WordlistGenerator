...
# Generate variations
print("\n💨 Generating word variations... (The generator is smoking!)\n")
time.sleep(1)
...
print(f"\n✅ Wordlist generated successfully: {WORDLIST_FILE}")
